      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Our fitness center platform offers a range of features designed specifically for JCU students and staff</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="shadow-md hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">Set fitness goals, track your attendance, and earn achievements as you maintain your routine.</p>
              </CardContent>
            </Card>
